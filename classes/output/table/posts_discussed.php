 ...
 *
 */
class posts_discussed extends posts_base
{
    /**
     * @param $forums
    ...
    {
        $this->sortable(true, 'discussed', 'DESC');
    ...
    {
        $this->define_headers(['Post count', 'Post', 'Forum', 'User', 'Date']);
        $this->define_columns(['discussed', 'post', 'forumname', 'userfullname', 'modified']);
